...
{
    public partial class InBankAccontOrderElementForm : Window, INotifyPropertyChanged
    {
        ...
        private InBankAccontOrder _data = new();
        ...
        public InBankAccontOrderElementForm(Guid id = default)
        {
            ...
            if (id != default)
            {
                var data = _documentController.GetDocument<InBankAccontOrder>(id);
                if (data != null)
                {
                    _data = data;
        ...
        public InBankAccontOrderElementForm(InBankAccontOrder data)
        {
            _handbookController = DIContainer.ServiceProvider.GetRequiredService<IHandbookController>();
            _documentController = DIContainer.ServiceProvider.GetRequiredService<IDocumentController>();
            _infoController = DIContainer.ServiceProvider.GetRequiredService<IInformationRegisterController>();
