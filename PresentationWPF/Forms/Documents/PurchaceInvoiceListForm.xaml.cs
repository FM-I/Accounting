...
{
    public partial class PurchaceInvoiceListForm : Window
    {
        ...
        public PurchaceInvoiceListForm(bool select = false)
        {
        ...
        {
            var list = _controller.GetDocuments<PurchaceInvoice>();
        ...
        private void dataList_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            var elementForm = new PurchaceInvoiceElementForm(item.Id);
            elementForm.Show();
        }

        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            var elementForm = new PurchaceInvoiceElementForm();
            elementForm.Show();
        }
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ListItem item = (ListItem)dataList.SelectedItem;
            var data = _controller.GetDocument<PurchaceInvoice>(item.Id);
        ...
        private void copyBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (data != null)
            {
                var elementForm = new PurchaceInvoiceElementForm((PurchaceInvoice)data.DeepCopy());
                elementForm.Show();
            }
        }
