...
{
    public partial class ProviderOrderListForm : Window
    {
        ...
        public ProviderOrderListForm(bool select = false)
        {
        ...
        private void dataList_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            var elementForm = new ProviderOrderElementForm(item.Id);
            elementForm.Show();
        }

        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            var elementForm = new ProviderOrderElementForm();
            elementForm.Show();
        }
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ListItem item = (ListItem)dataList.SelectedItem;
            var data = _controller.GetDocument<ProviderOrder>(item.Id);
        ...
        private void copyBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (data != null)
            {
                var elementForm = new ProviderOrderElementForm((ProviderOrder)data.DeepCopy());
                elementForm.Show();
            }
        }
        ...
        private void FillPurchaceInvoice_Click(object sender, RoutedEventArgs e)
        {
            ...
            var order = _controller.GetDocument<ProviderOrder>(item.Id);
