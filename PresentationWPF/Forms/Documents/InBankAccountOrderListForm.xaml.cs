...
{
    public partial class InBankAccountOrderListForm : Window
    {
        ...
        public InBankAccountOrderListForm(bool select = false)
        {
        ...
        private void dataList_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            var elementForm = new InBankAccontOrderElementForm(item.Id);
            elementForm.Show();
        }

        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            var elementForm = new InBankAccontOrderElementForm();
            elementForm.Show();
        }
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ListItem item = (ListItem)dataList.SelectedItem;
            var data = _controller.GetDocument<InBankAccontOrder>(item.Id);
        ...
        private void copyBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (data != null)
            {
                var elementForm = new InBankAccontOrderElementForm((InBankAccontOrder)data.DeepCopy());
                elementForm.Show();
            }
        }
        ...
        private void FillPurchaceInvoice_Click(object sender, RoutedEventArgs e)
        {
            ...
            var order = _controller.GetDocument<InBankAccontOrder>(item.Id);
