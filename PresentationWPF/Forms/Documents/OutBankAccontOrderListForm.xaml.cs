...
{
    public partial class OutBankAccontOrderListForm : Window
    {
        ...
        public OutBankAccontOrderListForm(bool select = false)
        {
        ...
        {
            var list = _controller.GetDocuments<OutBankAccontOrder>();
            ...
            foreach (var item in list)
            {
                items.Add(new(item.Id,
                    ...
                    item.Client.Name,
                    item.Summa,
                    item.Operation == Domain.Enum.TypePayment.Client ? "Покупцю" : "Постачальнику"));
            }
        ...
        private void dataList_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            var elementForm = new OutBankAccontOrderElementForm(item.Id);
            elementForm.Show();
        }

        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            var elementForm = new OutBankAccontOrderElementForm();
            elementForm.Show();
        }
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ListItem item = (ListItem)dataList.SelectedItem;
            var data = _controller.GetDocument<OutBankAccontOrder>(item.Id);
        ...
        private void copyBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (data != null)
            {
                var elementForm = new OutBankAccontOrderElementForm((OutBankAccontOrder)data.DeepCopy());
                elementForm.Show();
            }
        }
        ...
        private void FillPurchaceInvoice_Click(object sender, RoutedEventArgs e)
        {
            ...
            var order = _controller.GetDocument<OutBankAccontOrder>(item.Id);
