...
{
    public partial class OutCashOrderElementForm : Window, INotifyPropertyChanged
    {
        ...
        private OutCashOrder _data = new();
        ...
        public OutCashOrderElementForm(Guid id = default)
        {
            ...
            if (id != default)
            {
                var data = _documentController.GetDocument<OutCashOrder>(id);
                if (data != null)
                {
                    _data = data;
        ...
        public OutCashOrderElementForm(OutCashOrder data)
        {
            _handbookController = DIContainer.ServiceProvider.GetRequiredService<IHandbookController>();
            _documentController = DIContainer.ServiceProvider.GetRequiredService<IDocumentController>();
            _infoController = DIContainer.ServiceProvider.GetRequiredService<IInformationRegisterController>();
