...
{
    public partial class CashBoxElementForm : Window, INotifyPropertyChanged
    {
        private readonly IHandbookController _contorller;
        public event PropertyChangedEventHandler? PropertyChanged;
        private CashBox _data = new();
        ...
        public CashBoxElementForm(Guid id = default)
        {
            DataContext = this;
            ...
            if (id != default)
            {
                var data = _contorller.GetHandbook<CashBox>(id);
        ...
        public CashBoxElementForm(CashBox data)
        {
            DataContext = this;
            _contorller = DIContainer.ServiceProvider.GetRequiredService<IHandbookController>();
            _data = data;
