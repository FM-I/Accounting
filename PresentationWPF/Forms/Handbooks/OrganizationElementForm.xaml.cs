...
{
    public partial class OrganizationElementForm : Window, INotifyPropertyChanged
    {
        private readonly IHandbookController _contorller;
        public event PropertyChangedEventHandler? PropertyChanged;
        private Organization _data = new();
        ...
        public OrganizationElementForm(Guid id = default)
        {
            DataContext = this;
            ...
            if (id != default)
            {
                var data = _contorller.GetHandbook<Organization>(id);
        ...
        public OrganizationElementForm(Organization data)
        {
            DataContext = this;
            _contorller = DIContainer.ServiceProvider.GetRequiredService<IHandbookController>();
            _data = data;
