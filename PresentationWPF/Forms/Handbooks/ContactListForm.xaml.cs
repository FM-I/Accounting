...
{
    public partial class ContactListForm : Window
    {
        private readonly IHandbookController _controller;
        private readonly IDbContext _context;
        private bool _select;
        public Guid SelectedId { get; set; }
        public ContactListForm(bool select = false)
        {
        ...
        {
            var list = _controller.GetHandbooks<Contact>();
        ...
        private void dataList_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            var elementForm = new ContactElementForm(item.Id);
            elementForm.Show();
        }

        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            var elementForm = new ContactElementForm();
            elementForm.Show();
        }
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ListItem item = (ListItem)dataList.SelectedItem;
            var data = _controller.GetHandbook<Contact>(item.Id);
        ...
        private void copyBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (data != null)
            {
                var elementForm = new ContactElementForm((Contact)data.DeepCopy());
                elementForm.Show();
            }
        }
